...
namespace ADL.Core
{
    public static class Logger
    {
        ...
        {
            string oneTab = Helpers.Tabs(4, 1);
            string formattedMessage = logType + ":";
            formattedMessage += "\n{";
            formattedMessage += "\n" + oneTab + "Message:";
            formattedMessage += "\n" + oneTab + "{";
            formattedMessage += "\n" + oneTab + oneTab + Helpers.Indent(message, SPACES_PER_TAB, 2);
            formattedMessage += "\n" + oneTab + "}";
            formattedMessage += "\n" + oneTab + "Stack Trace:";
            formattedMessage += "\n" + oneTab + "{";
            formattedMessage += "\n" + oneTab + oneTab + Helpers.Indent((new StackTrace(2, true)).ToString(), SPACES_PER_TAB, 2);
            formattedMessage += "\n" + oneTab + "}";
            formattedMessage += "\n}\n";
